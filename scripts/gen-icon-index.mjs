...
const out = {
  ...
  // A fixed string, not today's date. CI regenerates this file and fails on any
  // diff, so a date made every push on a later day fail — output must depend on
  // the source alone. gen-manifest and build-rulebook do the same.
  generated: 'scripts/gen-icon-index.mjs — derived from src/icons, do not edit by hand',
  package: pkg,
  count: icons.length,

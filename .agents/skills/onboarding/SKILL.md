...
<!-- GENERATED from .claude/skills/onboarding/SKILL.md by scripts/gen-agent-rules.mjs. Do not edit — edit the source and run npm run ds:build. -->
...
|---|---|
| build a screen, try an idea | **the Playground** — `xui-playground`, `npm run dev` on :5174, deployed at https://xui-playground.vercel.app |
